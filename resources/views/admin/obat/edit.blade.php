...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('obatUpdate', $obat->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-xl-6 mb-2">
                        ...
                        <input type="text" name="satuan" class="form-control @error('satuan') is-invalid @enderror"
                            value="{{ old('satuan', $obat->satuan) }}" placeholder="Contoh: Tablet, Botol, Strip">
                        @error('satuan')
                            <small class="text-danger">{{ $message }}</small>
                        @enderror
                    </div>
                ...
                <div class="row mb-2">
                    <div class="col-xl-12">
                        ...
                        @if ($obat->gambar)
                            <div class="mt-2">
                                <img src="{{ asset('images/obat/' . $obat->gambar) }}" alt="Gambar Obat"
